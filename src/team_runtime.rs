...
pub fn prompt(team: &TeamSpec, max_agents: u32, user_prompt: &str) -> Result<String> {
    ...
    Ok(format!(
        "STACKPULSE · PERFIL ATIVO: {name}\n\
         ...
         Use as ferramentas nativas de delegação e os papéis registrados com os identificadores exatos do perfil. Cada papel tem seu modelo, esforço, finalidade e condição. Não substitua silenciosamente modelos ou esforços nem herde os do orquestrador quando o papel especificar outros.\n\
